...
class sctvRequestService implements iHttpClient {
    ...
    private function getSCTVHeader() {
        return [
            ...
            'Cookie' => '__atuvc=5%7C20%2C8%7C21%2C7%7C22; _ga=GA1.3.1540978709.1463362280; _gat=1',
    ...
    function getSCTVFormParams($channelExternalId, $date) {
        ...
        $formattedDateTime = date_format($date, 'Y-m-d-H-i-s');
        ...
        return [
            ...
            'ctl00$txtMasterSearch' => null,            
            'ctl00$ContentPlaceHolder1$ctl00$ctl01$ddlChannel' => $channelExternalId,
            'ctl00$ContentPlaceHolder1$ctl00$ctl01$sDate' => $formattedDate,
            'ctl00$ContentPlaceHolder1$ctl00$ctl01$sDate$dateInput' => $formattedDateTime,               
            '__ASYNCPOST' => 'true',
    ...
    public function request($channelId, $date) {
        $client = new Client();
        $header = $this->getSCTVHeader();
        $formParams = $this->getSCTVFormParams($channelId, $date);
